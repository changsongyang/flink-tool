...
import com.lzhpo.pulsarflink.ConsumerSourceFactory;
...
public class PulsarFlinkSource<T> extends RichSourceFunction<byte[]> {
     ...
     */
    private void receiveAlways(SourceContext<byte[]> ctx) throws InterruptedException, ExecutionException, IOException {
